...
class ExpenseApp(QWidget):
    ...
    def apply_style(self):
        self.setStyleSheet("""
            ...
            /* Table styling */
            QTableWidget {
                background-color: #f5f5dc; /* Cream color for table background */
                gridline-color: #c0c9d0;
                selection-background-color: #4caf50;
                selection-color: white;
                font-size: 14px;
                color: black; /* Black text for table content */
                border: 1px solid #cfd9e1;
            }
            QHeaderView::section {
                background-color: #8b4513; /* Dark brown for table headers */
            ...
            /* Add button styling */
            QPushButton {
                background-color: #006400; /* Dark green background for add button box */
                color: white;
                padding: 10px 15px;
                border-radius: 5px;
                font-size: 14px;
            ...
            QPushButton:hover {
                background-color: #20B2AA; /* Slightly lighter green on hover */
            }
            QPushButton:pressed {
                background-color: #004d00; /* Even darker green on press */
            }
